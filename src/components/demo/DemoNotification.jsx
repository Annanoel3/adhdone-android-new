...
export default function DemoNotification({ item, index }) {
  return (
    <motion.div
      ...
      className="w-full rounded-2xl bg-white/95 shadow-[0_6px_24px_rgba(0,0,0,0.1)] px-3.5 py-2.5 backdrop-blur"
    >
      ...
      <p className="text-[13px] text-gray-600 leading-snug mt-0.5">{item.body}</p>
      {item.why && (
